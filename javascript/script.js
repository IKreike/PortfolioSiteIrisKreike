...
const FEDsite = {
    ...
    plaatje4: "./Assets/PortfolioPics/FEDsite/FEDmenu.jpg",
    plaatje3: "./Assets/PortfolioPics/FEDsite/contact-light.jpg",
    plaatje2: "./Assets/PortfolioPics/FEDsite/contact-dark.jpg",
    kwaliteit1: "HTML",
    kwaliteit2: "CSS",
...
const characters = {
    ...
    plaatje4: "./Assets/PortfolioPics/Kaarten/map-1.1.jpg",
...
function updateTekst() {
    ...
    //toggle the buttons als het de laatste of de eerste is
    if (i == 1) {
